      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden py-20">
        ...
        >
          ...
          <h1 className="font-bold text-4xl sm:text-5xl md:text-6xl mb-6">
            ...
            <span className="bg-linear-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent">Solutions</span>
          </h1>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, idx) => (
              ...
              >
                <div className={`absolute inset-0 bg-linear-to-br ${service.linear} rounded-2xl opacity-0 group-hover:opacity-10 transition-opacity duration-300`}></div>
                <div className="relative h-full p-8 rounded-2xl bg-linear-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 hover:border-cyan-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-cyan-500/10 flex flex-col">
                  <div className={`w-12 h-12 rounded-lg bg-linear-to-br ${service.linear} flex items-center justify-center text-white mb-4 group-hover:scale-110 transition-transform duration-300`}>
                    {service.icon}
                  </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="font-bold text-3xl sm:text-4xl md:text-5xl mb-4">
              ...
              <span className="bg-linear-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent">Process</span>
            </h2>
          ...
          <div className="grid md:grid-cols-4 gap-4">
            {[
              ...
              >
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-linear-to-r from-cyan-500 to-purple-600 text-white font-bold mb-4">
                  {item.step}
                </div>
