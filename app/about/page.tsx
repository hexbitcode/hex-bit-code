      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden py-20">
        ...
        >
          ...
          <h1 className="font-bold text-4xl sm:text-5xl md:text-6xl mb-6">
            ...
            <span className="bg-linear-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent">Digital Reality</span>
          </h1>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="font-bold text-3xl sm:text-4xl md:text-5xl mb-4">
              ...
              <span className="bg-linear-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent">Values</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, idx) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: idx * 0.1 }}
                className="p-6 rounded-2xl bg-linear-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 hover:border-cyan-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-cyan-500/10"
              >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="font-bold text-3xl sm:text-4xl md:text-5xl mb-4">
              ...
              <span className="bg-linear-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent">Team</span>
            </h2>
            <p className="text-lg text-gray-400 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {teamMembers.map((member, idx) => (
              ...
              >
                <div className="absolute inset-0 bg-linear-to-r from-cyan-500 to-purple-600 rounded-2xl opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
                <div className="relative p-8 rounded-2xl bg-linear-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50">
                  {/* Profile Image */}
                  ...
                  <a
                    ...
                    className="flex items-center justify-center gap-2 mb-6 px-4 py-2 rounded-lg bg-linear-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/30 hover:border-cyan-500/60 transition-all duration-300 group/link"
                  >
                    ...
                    {member.social.map((social, sidx) => {
                      ...
                      return (
                        <a
                          ...
                          className="w-10 h-10 rounded-lg bg-linear-to-br from-gray-700 to-gray-800 border border-gray-600 hover:border-cyan-500 text-gray-400 hover:text-cyan-400 flex items-center justify-center transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/25 hover:scale-110 cursor-pointer"
                        >
