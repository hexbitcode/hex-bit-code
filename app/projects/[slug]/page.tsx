...
export default function ProjectDetail() {
  ...
  if (!project) {
    return (
      <main className="overflow-hidden bg-linear-to-b from-black via-gray-900 to-black min-h-screen flex items-center justify-center">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="font-bold text-4xl mb-6 text-white">Project Not Found</h1>
          <p className="text-gray-400 mb-8">The project you&apos;re looking for doesn&apos;t exist.</p>
          <Link
            href="/projects"
            className="inline-flex items-center gap-2 px-6 py-3 bg-linear-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-semibold rounded-lg transition-all duration-300"
          >
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <div>
              {project.featured && (
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-linear-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-500/20 mb-6">
              ...
              <div className="flex flex-wrap gap-4">
                <a
                  ...
                  className="px-6 py-3 bg-linear-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-semibold rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/25 flex items-center gap-2 group"
                >
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="relative bg-linear-to-br from-gray-800 to-gray-900 rounded-3xl p-8 border border-gray-700/50 h-80 flex items-center justify-center overflow-hidden group">
                <div className="absolute inset-0 bg-linear-to-r from-cyan-500/10 to-purple-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              ...
              <motion.div
                ...
                className="absolute -bottom-6 -right-6 bg-linear-to-br from-cyan-500 to-purple-600 rounded-2xl p-4 shadow-xl shadow-cyan-500/25"
              >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {project.metrics.map((metric, idx) => (
              <motion.div
                ...
                className="p-8 rounded-2xl bg-linear-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 hover:border-cyan-500/50 transition-all duration-300 text-center"
              >
                <p className="text-sm text-gray-400 mb-2">{metric.label}</p>
                <p className="text-4xl font-bold bg-linear-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent">
                  {metric.value}
                </p>
              </motion.div>
            ))}
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {project.features.map((feature, idx) => (
              <motion.div
                ...
                className="flex gap-4 p-6 rounded-xl bg-linear-to-br from-gray-800/30 to-gray-900/30 border border-gray-700/30 hover:border-cyan-500/30 transition-all duration-300"
              >
                <div className="w-6 h-6 rounded-full bg-linear-to-br from-cyan-400 to-purple-500 flex items-center justify-center flex-shrink-0 mt-1">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {project.techDetails.map((tech, idx) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: idx * 0.05 }}
                className="p-6 rounded-xl bg-linear-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 hover:border-cyan-500/50 transition-all duration-300 group hover:shadow-lg hover:shadow-cyan-500/10"
              >
        ...
        <section className="relative py-16 md:py-24">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="max-w-3xl mx-auto p-8 md:p-12 rounded-2xl bg-linear-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 relative"
            >
              ...
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-linear-to-br from-cyan-400 to-purple-500"></div>
                <div>
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {relatedProjects.map((relProject, idx) => (
              ...
              >
                <Link href={`/projects/${relProject.slug}`}>
                  <div className="h-full group relative overflow-hidden rounded-2xl bg-linear-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 hover:border-cyan-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-cyan-500/10 p-6 cursor-pointer">
                    <div className="relative h-40 bg-linear-to-br from-gray-800 to-gray-900 rounded-xl flex items-center justify-center mb-4 overflow-hidden">
          ...
          >
            <Link
              href="/projects"
              className="inline-flex items-center gap-2 px-8 py-4 bg-linear-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-semibold rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/25"
            >
              View All Projects
              <ArrowRight className="w-4 h-4" />
            </Link>
