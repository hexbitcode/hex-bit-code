      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden py-20">
        ...
        >
          ...
          <h1 className="font-bold text-4xl sm:text-5xl md:text-6xl mb-6">
            ...
            <span className="bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent">Success</span>
          </h1>
            ...
            {projects.map((project, idx) => (
              ...
              >
                {project.featured && (
                  <div className="absolute -top-3 -right-3 z-20">
                    <motion.div
                      ...
                      className="flex items-center gap-1 bg-gradient-to-r from-cyan-500 to-purple-600 px-3 py-1 rounded-full"
                    >
                ...
                <Link href={`/projects/${project.slug}`}>
                  <div className="relative h-full overflow-hidden rounded-2xl bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 hover:border-cyan-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-cyan-500/10 cursor-pointer">
                    {/* Project Image Area */}
                      ...
                      <div className="flex gap-3">
                        <div className="flex-1">
                          <a
                            ...
                            className="w-full px-4 py-2 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white text-sm font-semibold flex items-center justify-center gap-2 transition-all duration-300"
                          >
