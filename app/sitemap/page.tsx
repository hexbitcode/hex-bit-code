  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white py-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        {/* Additional Info */}
        <div className="mt-12 bg-gradient-to-br from-cyan-500/10 to-purple-500/10 border border-cyan-500/30 rounded-lg p-8">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link
            href="/contact"
            className="group p-6 bg-gradient-to-r from-cyan-500/10 to-blue-600/10 border border-cyan-500/30 rounded-lg hover:border-cyan-500/60 transition-all duration-300"
          >
          ...
          <Link
            href="/services"
            className="group p-6 bg-gradient-to-r from-purple-500/10 to-pink-600/10 border border-purple-500/30 rounded-lg hover:border-purple-500/60 transition-all duration-300"
          >
            <div className="flex items-center justify-between">
              <div>
